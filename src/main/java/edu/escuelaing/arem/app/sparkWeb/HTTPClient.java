...
public class HTTPClient {
    ...
    private String[] ports={":8001",":80002",":8003"};
    ...
    public String getMessages(String path) throws IOException {
        Request request = request = new Request.Builder().url(baseUrl+ports[serverNumber]+path)
                .get()
                .build();
    ...
    public String postMessage(String message,String path) throws IOException {
        ...
        Request request = new Request.Builder().url(baseUrl+ports[serverNumber]+path)
                .post(body)
                .build();
